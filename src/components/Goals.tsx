        ...
        <div className="max-w-5xl w-full grid grid-cols-1 md:grid-cols-3 gap-6 px-6">
          {goals.map((goal, i) => (
            <motion.div
              ...
              className="group relative p-8 rounded-[2rem] bg-surface/50 backdrop-blur-2xl border border-secondary/20 h-[400px] flex flex-col justify-end overflow-hidden"
            >
              {/* The "Gloss" Shine Overlay */}
              <div className="absolute inset-0 bg-gradient-to-tr from-primary/20 via-transparent to-white/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
